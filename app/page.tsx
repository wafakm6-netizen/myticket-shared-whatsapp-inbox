...
type Agent = { id: string; display_name: string; email?: string; role?: 'admin' | 'agent'; availability?: 'available' | 'away' | 'offline'; is_active?: boolean; whatsapp_conversations?: { id: string; status: Status; whatsapp_contacts?: { display_name?: string; phone?: string } }[] }
