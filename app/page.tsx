...
export default function Page() {
  ...
  return <main className="app-shell">
    <aside className={`rail ${sidebarOpen ? 'rail-open' : ''}`}>
      ...
      <nav aria-label="Primary navigation" className="rail-nav"><button className="rail-item active" aria-label="Inbox"><Inbox size={20} /><span>Inbox</span><b>8</b></button><button className="rail-item" aria-label="Team"><Users size={20} /><span>Team</span></button><button className="rail-item" aria-label="Saved replies"><FileText size={20} /><span>Replies</span></button><button className="rail-item" aria-label="Tags"><Tag size={20} /><span>Tags</span></button></nav>
